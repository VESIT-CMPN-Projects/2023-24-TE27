...
import 'package:neurooooo/youtube_tips.dart';
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(Icons.favorite), // Icon for Questionnaire
              title: const Text('Lifestyle tips'),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const YouTubePlaylistPage(playlistUrl: 'https://www.youtube.com/watch?v=QFkAl5wHEbg&list=PLlOii0Z4d_GlI89-nBf1q9PjtcP_vFQT5')),
                );
              },
            ),
            ListTile(
